 ...
 *
 * $Id: verify.groovy 13468 2011-01-26 19:29:58Z pgier $
 * $HeadURL: http://svn.codehaus.org/mojo/tags/license-maven-plugin-1.0-beta-2/src/it/update-file-header/update-file-header-specific/verify.groovy $
 * %%
